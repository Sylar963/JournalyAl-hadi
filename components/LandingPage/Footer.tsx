      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-gray-500">
            &copy; {new Date().getFullYear()} Delta Trading Journal. All rights reserved.
          </div>
          <div className="flex gap-8">
            ...
            <a href="mailto:contact@deltajly.xyz" className="text-gray-500 hover:text-white transition-colors">Contact</a>
          </div>
        </div>
      </div>
    </footer>
